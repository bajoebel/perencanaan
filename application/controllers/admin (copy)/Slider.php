    ...
    function simpan(){
        ...
        if(!empty($priv)){
            ...
            if(empty($row)){
                ...
                {
                    $create_dir = "public/img/slider/original/";
                    ...
                    if(!empty($images)){
                        $error[]=$this->Slider_model->_file_resize($create_dir."/" .$images, './public/img/slider/thumb/THUMB_' .$images, 300,300);
                        $icon[]=$this->Slider_model->_file_resize($create_dir."/" .$images, '../public/img/slider/icon/ICON_' .$images, 50,50);
                        $data=array(
