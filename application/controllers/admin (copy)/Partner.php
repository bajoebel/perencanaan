        ...
        if(!empty($priv)){
            ...
            if(empty($row)){
                ...
                if($this->form_validation->run())
                {
                    ...
                    if(!empty($images)){
                        // $error[]=$this->Partner_model->_file_resize($create_dir."/" .$images, './public/img/partner/thumb/THUMB_' .$images, 300,300);
                        // $icon[]=$this->Partner_model->_file_resize($create_dir."/" .$images, '../public/img/partner/icon/ICON_' .$images, 50,50);
                        $data=array(
