            ...
            <div class="row">
                ...
                <div class='col-md-12' id="form_box" style="display:none;">
                    <div class="form-box">
                        ...
                        <div class="form-body">
                            <form action="<?= base_url() ."admin/berita/simpan"; ?>" id="form" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-12" for="email">Kategori:</label>
                                        <div class="col-sm-12">
                                            <select name="post_kategori_id" id="post_kategori_id" class="form-control" required>
                                            ...
                                            <div class="text-error" id="err_post_kategori_id"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-12" for="email">Isi Berita:</label>    
                                        <div class="col-md-12">
