<?php if(!empty($halaman)) { ?>
	...
	<div class="isi">
		...
		if(!empty($halaman->post_image)) {
			?>
			<img data-attachment-id="1591" data-permalink="<?php echo base_url() ."public/img/blog/original/" .$halaman->post_image; ?>" data-orig-file="<?php echo base_url() ."public/img/blog/original/" .$halaman->post_image; ?>" data-orig-size="960,639" data-comments-opened="1" data-image-meta="{" aperture":"0","credit":"","camera":"","caption":"","created_timestamp":"0","copyright":"","focal_length":"0","iso":"0","shutter_speed":"0","title":"","orientation":"0"}"="" data-image-title="<?php echo $halaman->post_image; ?>" data-image-description="" data-medium-file="<?php echo base_url() ."public/img/blog/original/" .$halaman->post_image; ?>" data-large-file="<?php echo base_url() ."public/img/blog/original/" .$halaman->post_image; ?>" class="img img-thumbnail" src="<?php echo base_url() ."public/img/blog/thumb/THUMB_" .$halaman->post_image; ?>" alt="" style="width: 100%;">
			<?php
		}
			...
			foreach ($komentar as $kom) {
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 ">
						<div class="bubble">
							<div class="col-md-2 col-sm-2 col-xs-2"><img src="<?php echo base_url() ."img/bubbles-icon.png" ?>" class="img img-responsive"></div>
