...
$route['profil-baznas'] ='welcome/profile';
$route['mitra-baznas'] ='welcome/mitra';
$route['kalkulator-zakat'] ='welcome/kalkulator';
$route["ppid"]='welcome/ppid';
$route["galeri"]='welcome/galeri';
$route["video"]='welcome/video';
$route["artikel"]='welcome/blog';


$route['download'] ='welcome/download';
$route['pengaduan-baznas']='welcome/pengaduan';
...
$route['kategori/([a-zA-Z0-9-.]+)']=function ($link)
{
	return 'welcome/kategori/'. strtolower($link) ;
};
