function getKomentar(){
	...
	var url = base_url + "welcome/komentar/"+post_id;
	$.ajax({
        url : url,
        type: "GET",
        dataType: "json",
        ...
        success : function(data){
            ...
            for(var i=0;i<jmlData;i++){
				...
				media+='<div class="col-md-2 col-sm-2 col-xs-2"><img src="'+base_url+'img/bubbles-icon.png' +'" class="img img-responsive"></div>';
...
function insertKomentar(){
    ...
    if(jml!=jawaban) {
        var opt1=getRndInteger(1,10);
        var opt2=getRndInteger(1,10);
        $('#opt1').html(opt1);
        $('#opt2').html(opt2);
	...
	var url = base_url + "welcome/insertkomentar";
    $.ajax({
        url : url,
        type: "POST",
        data : formData,
...
function cari(){
	var q = $('#q').val();
	var url = base_url + "welcome/list_berita/?q="+q;
	console.log(url);
	$.ajax({
        url : url,
        type: "GET",
