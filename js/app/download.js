            ...
            success : function(data){
                ...
                if(dir<1){
                    ...
                    for(var i=0;i<jmlData;i++){
                        ...
                        media+='<img src="'+base_url+'public/img/media/folder.png">'+row[i]["dir_nama"];
                        media+='</a>';
                        media+='</div>';
                        //media+='</div>';
                    }
                    ...
                    for(var i=0;i<jmlData;i++){
                        ...
                        media+='<th style="text-align:right"><a href="'+base_url+'media/'+row[i]['dir_nama']+'/'+row[i]["media_namafile"]+'" class="btn btn-success btn-sm">Download</a></th>';
                        media+='</tr>';
                    }
                    media+='<tr>';
                    media+='<td colspan="3">';
